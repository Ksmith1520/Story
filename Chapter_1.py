...
def maze():
    ...
    print("Make a choice")
    print("Go into the forest alone")
    print("Recruit people to help you search")
    print("Leave the scene")
    print("Choose a number")
    choice = input("> ")
...
def forest():
    ...
    print("Make a choice")
    print("Chase the shadow")
    print("Run from the shadow")
    print("Fight the shadow")
    print("Choose a number")
    choice = input("> ")
